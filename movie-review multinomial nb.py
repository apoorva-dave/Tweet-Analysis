...
def train_data(sentiment_data):
    #return random_data
    # 80% for training
    train_X, train_y = zip(*sentiment_data[:200])
...
def test_data(sentiment_data):
    # Keep 20% for testin
    test_X, test_y = zip(*sentiment_data[24900:])
...
#
    ...
    test_data = ["Food is good","I hate you"]
...
def main():
    ...
    #print(random_data)
    unigrams(train_X,train_y,test_X,test_y)     #0.85
    bigrams(train_X,train_y,test_X,test_y)      #0.8864
    unigram_bigram(train_X,train_y,test_X,test_y)  #0.88
